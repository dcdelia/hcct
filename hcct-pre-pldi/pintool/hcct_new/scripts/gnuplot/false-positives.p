...
set terminal x11
set title "Classification of ({/Symbol f},{/Symbol e})-HCCT nodes\n\nBenchmarks: amarok, ark, audacity, bluefish, dolphin, firefox, gedit, ghex2, gimp,\n sudoku, gwenview, inkscape, oocalc, ooimpress, oowriter, pidgin, quanta, vlc"
#set auto x
set key under
...
plot \
     ...
     '' using (100*$9/$7)  notitle fs lc rgb "red",\
     '' using (100*$10/$7) notitle fs lc rgb "black",\
     newhistogram,\
     ...
     '' using (100*$9/$7)  notitle fs lc rgb "red",\
     '' using (100*$10/$7) notitle fs lc rgb "black"
set terminal postscript eps color enhanced dashed "Helvetica" 15
set output 'false-positives.eps'
replot
