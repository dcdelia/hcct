...
//                           list of free blocks
pool_t* pool_init(size_t page_size, size_t block_size, void** free_list_ref) __attribute__((no_instrument_function));
...
void pool_cleanup(pool_t* p) __attribute__((no_instrument_function));
...
void pool_dump(pool_t* p, void* free_list, int dump_heap) __attribute__((no_instrument_function));
...
// ---------------------------------------------------------------------
// for internal use...
void* _pool_add_page(pool_t* p, void** free_list) __attribute__((no_instrument_function));
