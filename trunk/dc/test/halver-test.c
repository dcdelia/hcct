 ...
 *  Last changed:   $Date: 2010/11/16 15:13:03 $
...
char* do_from_scratch_eval(test_t* test) {
    ...
    // makes halver...
    test->halver = halver_new(test->ra, test->rout1, test->rout2);
    if (test->halver == NULL) return "can't build halver";
